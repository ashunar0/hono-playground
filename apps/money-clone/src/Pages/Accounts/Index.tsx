...
import { type AccountType, ACCOUNT_TYPES, accountTypeLabels } from "@/features/accounts/schema";
                ...
                <li class="flex items-center justify-between rounded border border-gray-200 bg-white px-4 py-3">
                  <div class="flex flex-col">
                    ...
                    <span class="text-sm text-gray-500">
                      {accountTypeLabels[a.type as AccountType]} ・ 初期残高{" "}
                      {formatYen(a.initialBalance)}
                    </span>
                  </div>
